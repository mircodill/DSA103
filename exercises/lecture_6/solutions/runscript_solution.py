...
data_a = load_and_clean_setup_data("exercises/lecture_6/data/setup_A.csv", "A") #MD: old bracket was: (r"C:\Users\jschoer\Desktop\DSA103 Coding and Tests\DSA103\exercises\lecture_6\data\setup_A.csv", "A")
data_b = load_and_clean_setup_data("exercises/lecture_6/data/setup_B.csv", "B") #MD: old bracket was: (r"exercises\lecture_6\data\setup_B.csv", "B")
